...
function PlaylistSong( {wid} ) {
  return (
    <div id={styles.container}>
        ...
        <p id={styles.album} style={{marginLeft: wid == '53.2vw' ? 170: 366}} className={styles.hover}>VERDI REQUIEM</p>
        <p id={styles.date} style={{marginLeft: wid == '53.2vw' ? 143: 277}}>4 days ago</p>
