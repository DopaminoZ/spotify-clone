...
function PlaylistSong( {song,wid, index} ) {
  ...
  {song.track.artists.map((artist) => artist.name).join(', ')}
        ...
        <p id={styles.album} style={{marginLeft: wid == '53.2vw' ? 170: 366}} className={styles.hover}>{song.track.album.name}</p>
        <p id={styles.date} style={{marginLeft: wid == '53.2vw' ? 143: 277}}>{daysAgo(song.added_at)} days ago</p>
