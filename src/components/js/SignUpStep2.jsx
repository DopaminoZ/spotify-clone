...
function SignUp2({ formData, onFormDataChange, history }) {
  const goNext = () => {
    if (
      ...
      formData.dob.day &&
      formData.gender &&
      isValidDay(formData.dob.day, formData.dob.month) &&
  ...
  return (
    <div className={styles.container}>
      ...
      <div id={styles.genderdiv}>
        <label>Gender</label>
        <p id={styles.genderpara}>
          We use your gender to help personalise our content recommendations and
          ads for you.
        </p>
      ...
      <div className={styles.socials}>
        <button type="button" id={styles.next} onClick={goNext}>
          Next
        </button>
      </div>
