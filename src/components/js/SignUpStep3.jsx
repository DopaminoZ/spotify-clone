    ...
    <div className={styles.container}>
      ...
      <div className={styles.checkbox}>
        <input
          type="checkbox"
          className="chk"
          checked={formData.sharedata === true}
      ...
      <p className={styles.lasttexts}>
        By clicking on ‘Sign up’, you agree to Spotify’s{" "}
        <p className={styles.links}>Terms and Conditions of Use.</p>
      </p>
      <p className={styles.lasttexts}>
        To learn more about how Spotify collects, uses, shares and protects your
        personal data, please see{" "}
        <p className={styles.links}>Spotify’s Privacy Policy.</p>
      </p>
      <div className={styles.socials}>
        <button type="submit" onClick={(e) => handleSignUp(e)} id={styles.next}>
          Sign Up
        </button>
      </div>
      <label id={styles.disclaimer}>
        This site is a clone and isn't meant to break any kind of copyright or
        laws.
        <br />
